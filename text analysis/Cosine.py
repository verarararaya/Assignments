...
def load_docs():
 print("Loading docs...")
 doc1=('d1', 'request delay beg parliament leader')
 doc2=('d2', 'EU react referendum UK decision')
 doc3=('d3', 'brexit delay react UK parliament')
 # doc4=('d4', 'brexit delay parliament')
 # doc5=('d5', 'brexit delay request EU parliament UK react referendum')
 # doc6 = ('d6', 'brexit delay request EU parliament fool house')
 # doc7 = ('d7', 'brexit delay request UK parliament beg')
 # doc8 = ('d8', 'request delay beg parliament leader ')
 return [doc1, doc2,doc3,]
# doc4,doc5,doc6,doc7,doc8
...
text2 = 'd2'
text3 = 'd3'
cosine = edistance(text1, text3)
print('Cosine:', round(cosine,2))
